...
public class BoardTests {
	...
	@Test
	public void testBoardConstructor() { //sanity check
		Board testBoard= new Board(8,9); 
		assertEquals("Width does not match initialization value", 8, testBoard.getWidth());
		assertEquals("Height does not match initialization value.", 9, testBoard.getHeight());
	}

	@Test
	public void testPlaceShip() { //test getting as setting ships
        int boardWidth = 8;
        int boardHeight = 8;
